  ...
  >
    ...
    <div class="filters_and_transactions">
        ...
        <div class="item_filters">
          <div class="filter_buttons_row">
            <button
              ...
              class="filter_button"
              :class="{ active: filter.id === category.id }"
      ...
      <div
        ...
        v-if="additionalInfosEnabledCount > 0 && filter.name !== 'Дни рождения'"
      >
