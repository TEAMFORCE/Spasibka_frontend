<template>
  <div class="challenge_comments_wrapper">
    <div class="comment_list_wrapper" :class="{ margin24: comments?.length }">
      ...
      <div v-if="countOfComments">
        <button
          v-if="countOfComments.comments > 3 && !showAll"
    ...
    <div class="comment_input_wrapper">
      ...
      <div class="send_button">
        <button class="send_comment" @click="sendComment">
