...
import { useStore as useTestUserPermissionStore } from "@/store/TestUserPermitionStore/index";
...
export default {
  ...
  computed: {
    ...mapStores(useTestUserPermissionStore),
  },
  watch: {
    userList() {
      ...
      this.testUserPermissionStore.setUserList(this.userList);
      this.testUserPermissionStore.setUserListForSend(this.userListToSend);
    },
  },
  methods: {
    async getUsers() {
      if (this.testUserPermissionStore.userList.length) {
        this.userList = this.testUserPermissionStore.userList;
        this.userListToSend = this.testUserPermissionStore.userListForSend;
      } else {
