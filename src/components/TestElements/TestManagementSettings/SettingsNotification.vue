<template>
  <div class="settings_notifications">
    <h2 class="settings_notifications_title">
      {{ $t("tests.settings.notificationSettings.title") }}
    </h2>
    <div class="settings_notifications_item" v-if="settingsAdded">
      <h3 class="_item_title">
        {{ $t("tests.settings.notificationSettings.endSurveyNotification") }}
      </h3>
    ...
    <div class="settings_notifications_item" v-if="settingsAdded">
      <h3 class="_item_title">
        {{ $t("tests.settings.notificationSettings.endComingNotification") }}
      </h3>
      <div class="item_switch">
        <label class="switch">
          <input
    ...
    <div class="settings_notifications_item" v-if="settingsAdded">
      <h3 class="_item_title">
        {{
          $t("tests.settings.notificationSettings.endComingUserNotification")
        }}
      </h3>
      <div class="item_switch">
        <label class="switch">
    ...
    <div class="settings_notifications_item" v-if="settingsAdded">
      <h3 class="_item_title">
        {{
          $t("tests.settings.notificationSettings.surveyCreatedNotification")
        }}
      </h3>
      <div class="item_switch">
        <label class="switch">
