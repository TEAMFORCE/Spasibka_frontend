<template>
  <div class="my_pulse_chart" v-if="chartData.length > 0">
    <ApexCharts
      type="donut"
    ...
    <div class="total_transaction_count_wrapper">
      ...
      <div class="total_tooltip">
        {{
          `${$t(
            "mainPage.totalCountTransactionsToMe"
  ...
  watch: {
    values() {
      ...
      this.totalTransaction =
        this.values.count_as_recipient /*+ this.values.count_as_sender*/;
