<template>
  <div class="user_activity_challenges_diagrams">
    <BarChartChallenges 
...
export default {
  name: "UserActivityChallengesDiagrams",
  props: {
    isLoading: {
      required: true
    }
...
<style scoped>
.user_activity_challenges_diagrams {
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
}
