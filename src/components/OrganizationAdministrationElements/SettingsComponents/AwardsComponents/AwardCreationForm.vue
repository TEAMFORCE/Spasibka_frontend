<template>
  <div class="award_creation_form_wrapper">
    <div class="award_creation_form general-white-bg">
      <div class="award_creation_header">
        <h1 class="award_creation_header_text general-contrast-color">
          {{ $t("organization.settings.award_creation") }}
        </h1>
        <h1 class="award_creation_header_text general-contrast-color">
      ...
      <div v-show="step === 1" class="field_inputs">
        <div class="input_field_wrapper">
          ...
          <input
            class="award_creation_text_input general-contrast-color general-white-bg"
            v-model="awardName"
        ...
        <div class="input_field_wrapper">
          ...
          <textarea
            class="award_creation_text_input textarea_height general-contrast-color general-white-bg"
...
export default {
  name: "AwardCreationForm",
  emits: ["closeAwardCreation"],
  components: {
    Datepicker,
    AddAwardPhotoIcon,
    vSelect,
  ...
  methods: {
    ...
    async createAwardType() {
      try {
        ...
        this.$emit("closeAwardCreation");
        notify(this.$t("organization.settings.award_got_created"), "success");
      } catch (err) {
        notify(
...
.award_creation_header {
  display: flex;
  justify-content: space-between;
}
.award_creation_header_text {
  font-family: "Ubuntu";
  font-size: 20px;
  font-weight: 500;
  line-height: 23px;
